...
// The same five questions asked about yourself. Kept as a separate list rather
// than generated by swapping pronouns: "How should I prepare against them?"
// does not become a sentence about yourself by any string substitution — the
// question a player asks about their own game is a different question.
const SUGGESTED_SELF = [
  "Which openings do I play most?",
  "Where do I score worst?",
  "What's my record against stronger opponents?",
  "What should I be working on?",
  "What's my rating trend over the last three years?",
];
...
interface AskAssistantProps {
  slug: string;
  playerName?: string;
  /** True on /me. The backend independently detects this and switches the
   *  assistant to second person; this only keeps the prompts in step. */
  isSelf?: boolean;
}
          ...
          <textarea
            ...
            placeholder={
              turns.length
                ? "Ask a follow-up…"
                : isSelf
                  ? `Ask ${ASSISTANT_NAME} — e.g. which opening do I score worst with?`
