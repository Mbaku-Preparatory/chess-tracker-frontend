...
const SOURCE_TABS: {
...
}[] = [
  {
    ...
    color: "#7fa650",
    activeClass: "border-[#7fa650] bg-[#7fa650] text-white",
    icon: (
  ...
  },
  {
    ...
    shortLabel: "Lichess",
    color: "#b05000",
    activeClass: "border-[#b05000] bg-[#b05000] text-white",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
...
export default function PlayerImportPage() {
  ...
  const [activeSource, setActiveSource] = useState<ImportSource>(initialSource);
  ...
  const canSubmit =
    pgn.trim().length > 0 &&
    !loading &&
    (color !== "auto" || nameOverride.trim().length > 0);
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {/* Source selector */}
      <div className="mb-6">
        <p className="mb-3 text-sm font-medium text-gray-600">Import source</p>
        ...
        {activeSource === "pgn" && (
          <div className="rounded-xl border border-gray-200 bg-white p-5">
            <div className="mb-4 flex items-center gap-3">
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-gray-700 text-white">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} className="h-5 w-5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              </div>
              <div>
                <h3 className="font-semibold text-gray-900">Import from PGN file</h3>
                <p className="text-xs text-gray-500">Paste or upload a .pgn file directly</p>
              </div>
            </div>
              ...
              {color === "auto" && (
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-400">
                    How the player&rsquo;s name appears in the White/Black PGN headers. Partial
                    match is fine.
                  </p>
                </div>
              )}
